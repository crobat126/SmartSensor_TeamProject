...
class DefaultKakaoUtilService implements KakaoUtilService {
    ...
    private static final List<String> ALLOWED_PACKAGES = Arrays.asList(TALK_PACKAGE_NAME, SANDBOX_TALK_PACKAGE_NAME, ALPHA_TALK_PACKAGE_NAME, ONE_TALK_PACKAGE_NAME, STORY_PACKAGE_NAME);
}
