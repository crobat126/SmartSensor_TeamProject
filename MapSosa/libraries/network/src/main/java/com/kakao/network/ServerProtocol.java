...
public final class ServerProtocol {
    ...
    // push
    public static final String PUSH_REGISTER_PATH = V2_API_VERSION + "/push/register";
    public static final String PUSH_TOKENS_PATH = V2_API_VERSION + "/push/tokens";
    public static final String PUSH_DEREGISTER_PATH = V2_API_VERSION + "/push/deregister";
    public static final String PUSH_SEND_PATH = V2_API_VERSION + "/push/send";
